    ...
    while (tc--) {
        ...
        for (ll i = 0; i < num; ++i) {
            ...
            if(mpp.find(i) != mpp.end()) {
                vll temp;
                temp = cntArr;
                transform(temp.begin(), temp.end(), temp.begin(), bind1st(multiplies<ll>(), mpp[i]));
                transform (ans.begin(), ans.end(), temp.begin(), ans.begin(), plus<ll>());
            }
        }
        transform (ans.begin(), ans.end(), cntArr.begin(), ans.begin(), plus<ll>());
