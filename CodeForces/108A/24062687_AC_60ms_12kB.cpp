...
int main() {
    ...
    v1.pb(0);v1.pb(1);v1.pb(2);v1.pb(3);v1.pb(4);v1.pb(5);v1.pb(10);v1.pb(11);v1.pb(12);v1.pb(13);v1.pb(14);v1.pb(15);v1.pb(20);v1.pb(21);v1.pb(22);v1.pb(23);v1.pb(0);
    v2.pb(0);v2.pb(10);v2.pb(20);v2.pb(30);v2.pb(40);v2.pb(50);v2.pb(1);v2.pb(11);v2.pb(21);v2.pb(31);v2.pb(41);v2.pb(51);v2.pb(2);v2.pb(12);v2.pb(22);v2.pb(32);v2.pb(0);
    ...
    //cout << n << ' ' << m << " " << v1[pos] << " " << v2[pos] << endl;
    ll aa = 0, bb = 0, pre = (n * 60) + m;
    ll  now = (v1[pos] * 60) + v2[pos];
    //cout << v1[pos] << " " << v2[pos] << endl;
    //cout << pre << " " << now << endl;
    if (now > pre) {
        aa = v1[pos];
        bb = v2[pos];
